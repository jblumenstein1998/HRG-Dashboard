 ...
 *
 * Deliberately not the full alphabet: no O/0, I/l/1, so it survives being read
 * off a screen. Length compensates for the smaller set. These are short-lived
 * by construction — `must_reset` forces a change at first login.
 */
...
/**
 * The rule for a password someone chooses themselves.
 *
