 ...
 * Sign-in.
 *
 * Google is the way in: every account is on the company Workspace domain, so
 * there is no dashboard password to remember, lose or reset.
 *
 * The email and password form below it is a deliberate holdover, not a
 * fallback for general use. It exists so that a misconfigured OAuth client
 * can't lock everyone out of production — including the people who'd have to
 * fix it. Remove it once Google Sign-In is confirmed working.
 */
...
function LoginForm() {
  ...
  // The Google callback redirects here with ?error= when it turns someone away.
